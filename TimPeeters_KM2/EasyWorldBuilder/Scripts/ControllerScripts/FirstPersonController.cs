//This script is a modified version of the unity standard assets first person controller
//Modified for use in Easy Worldbuilder.
...
namespace WorldBuilderTool
{
    ...
    public class FirstPersonController : MonoBehaviour
    {
        ...
        */
        ...
        {
            m_MouseLook.LookRotation(m_CharacterController.transform, m_Camera.transform);
        }
